...
Fe-vacancy 缺陷体系 & 检查 vacancy-hop KMC 演化 & outputs/datasets/multiscale\_dataset.csv \\
...
3 & 不同温度、成分、缺陷、lattice size 条件下跨尺度演化计算 & multiscale\_dataset.csv; lattice\_size\_scan.csv; material\_evolution\_curves.png; parallel\_training\_display.csv & 完成 \\
