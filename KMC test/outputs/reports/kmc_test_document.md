...
本次跨尺度扫描网格包含温度 250 K, 300 K, 350 K, 400 K, 500 K, 600 K, 700 K, 800 K, 900 K, 1000 K，Cu density 0.0025, 0.005, 0.01, 0.0134, 0.02, 0.03, 0.05，vacancy density 0.0005, 0.001, 0.002, 0.003, 0.005。
...
| 逐步 KMC 记录 | 35000 |
| 能量结果行数 | 350 |
| 最终 pair energy 范围 | -14802.836887 到 -14434.278865 eV |
| Cu 最大团簇范围 | 1 到 167 |
| 三种规模 speedup | 11.857x, 6.767x, 5.516x |
| DeepH / DeepKS 并行扩展性记录 | 覆盖 1 到 1024 节点 |
| 输出清单记录文件数 | 25（不含 manifest 自身） |
