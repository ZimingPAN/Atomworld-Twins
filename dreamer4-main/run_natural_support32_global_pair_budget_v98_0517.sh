...
STAGE="${STAGE:-v98_global_pair_budget_smoke20}"
...

{
  ...
  echo "fix=v98 eval-only global pair budget for sequence/two-stage support compression"
} | tee -a "${LOG}"
...
run_eval "sequence_globalh_as_change_a32_d4" "terminal_edit_sequence_rollout" "none" 0 "action_source" 32 4 -1
run_eval "sequence_global16_as_change_a32_d4" "terminal_edit_sequence_rollout" "none" 0 "action_source" 32 4 16
run_eval "sequence_global24_as_change_a32_d4" "terminal_edit_sequence_rollout" "none" 0 "action_source" 32 4 24
run_eval "twostage_globalh_a32_d4" "two_stage_vacancy_displacement" "none" 0 "action_source" 32 4 -1
run_eval "twostage_global16_a32_d4" "two_stage_vacancy_displacement" "none" 0 "action_source" 32 4 16
run_eval "twostage_global24_a32_d4" "two_stage_vacancy_displacement" "none" 0 "action_source" 32 4 24
...
summary = {
    ...
    "diagnostic": "eval-only global pair budget for high-precision sequence/two-stage support compression",
    "files": {},
}
